<template>
    ...
    <p v-if="useTsPlugin">
        ...
        tsconfig plugins <br />2. Delete <code>src/shims-vue.d.ts</code>
        <br />3. Open <code>src/main.ts</code> in VSCode <br />4. Open VSCode
        command input <br />5. Search and run "Select TypeScript version" ->
